...
export const experiences: Experience[] = [
  ...
  //   githubLink: "",
  //   details: [
  //     "Developed a facility maintenance management platform using React 17+ and TypeScript, featuring role-based dashboards for supervisors to monitor real-time maintenance metrics and oversee operations across multiple facilities.",
  //     "Built task assignment interface enabling dispatchers to create, prioritize, and delegate maintenance requests with dynamic filtering and status tracking.",
  //     "Collaborated with UI/UX designers to implement company design standards across web and mobile platforms, translating Figma mockups into accessible React components using both internal design system libraries and custom components  for maintenance-specific workflows.",
  ...
  //     "Developed 15+ feature screens for maintenance mobile app using React Native 0.72+ with React Navigation and deep linking to streamline field staff workflows for task completion and status updates.",
  ...
  //     "Implemented offline‑first architecture using SQLite storage for maintenance tickets, form data, and image paths with metadata, enabling offline functionality with automatic synchronization when connectivity is restored.",
  //     "Automated mobile builds using Fastlane within Bitrise CI/CD pipeline, collaborating with DevOps to streamline cross-platform iOS/Android deployments for enterprise distribution.",
  //     "Collaborated with backend and QA teams to implement Jest and React Native Testing Library test coverage for critical user flows, utilizing AI code generation tools to accelerate test scaffolding while ensuring comprehensive edge case coverage through manual review.",
  //     "Established E2E testing framework using Detox for automated UI testing across iOS and Android platforms, ensuring consistent user experience and preventing regressions.",
  //   ],
  // },
  // {
