...
import { aiProjects } from "@/data/productivity/aiProjects";
...
export default function ProductivityPage() {
  ...
  const handleToggleAIProjects = () => {
    setShowAIProjects(!showAIProjects);
  };
  ...
  return (
    <>
      ...
      <SectionTitle backgroundText="Essential" foregroundText="Productivity" />
      ...
      <section className="pb-12">
        <div className="container mx-auto px-8 lg:px-20 xl:px-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <p className="text-gray-600 mb-2">
                Essential tools for development, productivity, and
                collaboration.
              </p>
              <div className="flex items-center justify-center space-x-2 text-primary">
                ...
                <i
                  className={`fa ${
                    showTools ? "fa-chevron-up" : "fa-chevron-down"
            ...
            >
              ...
              <p className="text-gray-600 mb-2">
                Useful websites for learning new technologies, reviewing
                concepts, and more.
              </p>
              <div className="flex items-center justify-center space-x-2 text-primary">
                <span className="text-sm font-medium">
                  {showWebsites ? "Hide Websites" : "Show All Websites"}
                </span>
                <i
                  className={`fa ${
                    showWebsites ? "fa-chevron-up" : "fa-chevron-down"
                  } text-sm transition-transform duration-300`}
                ></i>
              </div>
            </button>

            {/* AI Projects Stats - Clickable */}
            <button
              onClick={handleToggleAIProjects}
              className="bg-gray-50 rounded-xl p-8 hover:bg-gray-100 transition-colors cursor-pointer w-full group text-center"
            >
              <h3 className="text-2xl font-bold text-gray-800 mb-4 group-hover:text-primary transition-colors">
                AI Mini Projects
              ...
              <p className="text-gray-600 mb-2">
                Vibe coding projects for experimenting different libraries and
                technologies.
              </p>
              <div className="flex items-center justify-center space-x-2 text-primary">
                <span className="text-sm font-medium">
                  {showAIProjects ? "Hide Projects" : "Show All Projects"}
                </span>
                <i
                  className={`fa ${
                    showAIProjects ? "fa-chevron-up" : "fa-chevron-down"
                  } text-sm transition-transform duration-300`}
                ></i>
              </div>
            </button>
          ...
          {/* AI Projects Grid - Only show when showAIProjects is true */}
          {showAIProjects && (
            <div className="mb-16">
              <h2 className="text-3xl font-bold text-gray-800 mb-12 text-center">
                AI Mini Projects & Experiments
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {aiProjects.map((project, index) => (
                  ...
                  >
                    <div className="flex items-center justify-center mb-6">
                      <i
                        className={`fa fa-3x ${project.icon} text-primary mr-4 group-hover:scale-110 transition-transform duration-300`}
                      ></i>
                      <h4 className="font-bold text-xl text-gray-800">
                        {project.title}
                      </h4>
